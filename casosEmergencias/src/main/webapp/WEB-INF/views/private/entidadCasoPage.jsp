...
<body>
	...
	<form:form name="formEntidadCaso" action="guardar" modelAttribute="caso" method="POST">
		...
		<div id="divEntidadCaso" class="divEntidad">
			<div>
				...
				<div>
					<form:select path="peticion" items="${peticionList}" />
				</div>
				<div class="divLabel">
					<label><s:message code="entidadCaso_table_label_estado"/></label>
				</div>
				<div>
					<form:select path="estado" items="${statusList}" />
				</div>
			</div>
			<div>
				<div class="divLabel">
				...
				<div>
					<form:select path="estado" items="${substatusList}" />
				</div>
			</div>
			<div>
				<div class="divLabel">
				...
				<div>
					<form:select path="canalOrigen" items="${canalOrigenList}" />
				</div>
			</div>
		</div>	
	</form:form>
