	...
	table = $('#tablaSuministros').DataTable({
		...
		"ajax": { 
       	...
       	"columns": [
       	            ...
       	            {"data": "pointofdeliveryaddress__c",	"width": "20%", "defaultContent": "", "searchable": false, 	"orderable": true,	"visible": true},
       	            {"data": "municipality__c",				"width": "20%", "defaultContent": "", "searchable": false, 	"orderable": true,	"visible": true},
